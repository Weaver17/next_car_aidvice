    ...
    },
    {
    ...
    },
     {
      ...
      },
      {
        make: 'RAM',
        model: '2500',
        trims: ['Tradesman', 'Big Horn', 'Laramie', 'Power Wagon', 'Limited'],
        averagePrice: 45000,
        pros: ['High towing capacity', 'Comfortable ride'],
        cons: ['Poor fuel economy', 'Large size'],
        hybridOrElectric: 'None',
        type: 'Truck',
        size: 'full-size',
      },
      {
        make: 'RAM',
        model: '3500',
        trims: ['Tradesman', 'Big Horn', 'Laramie', 'Limited'],
        averagePrice: 50000,
        pros: ['High towing capacity', 'Powerful engine'],
        cons: ['Poor fuel economy', 'Large size'],
        hybridOrElectric: 'None',
        type: 'Truck',
        size: 'full-size',
      },
      {
        ...
        averagePrice: 40000,
        pros: ['Strong engine options', 'Good towing capacity'],
        cons: ['Basic interior', 'Can be expensive'],
        hybridOrElectric: 'None',
        type: 'Truck',
        size: 'full-size',
      },
      {
        make: 'GMC',
        model: 'Sierra 1500',
        trims: ['Base', 'SLE', 'Elevation', 'SLT', 'AT4', 'Denali'],
        averagePrice: 42000,
        pros: ['Refined interior', 'Comfortable ride'],
        cons: ['Can be expensive', 'Poor fuel economy'],
        hybridOrElectric: 'None',
        type: 'Truck',
        size: 'full-size',
      },
      {
        ...
        averagePrice: 60000,
        pros: ['Spacious interior', 'Comfortable ride', 'High towing capacity'],
        cons: ['Large size', 'Poor fuel economy'],
        hybridOrElectric: 'None',
        type: 'SUV',
        size: 'full-size',
      },
      {
        ...
        trims: ['Series I', 'Series II', 'Obsidian', 'Series III'],
        averagePrice: 80000,
        pros: ['Luxurious interior', 'Advanced technology', 'High towing capacity'],
        cons: ['Very expensive', 'Large size', 'Poor fuel economy'],
        hybridOrElectric: 'None',
        type: 'SUV',
        size: 'full-size',
      },
        ...
        make: 'Ford',
        model: 'Bronco Sport',
        trims: ['Base', 'Big Bend', 'Outer Banks', 'Badlands'],
        averagePrice: 28000,
        pros: ['Off-road capability', 'Stylish design', 'Spacious interior'],
        cons: ['Small cargo space', 'Limited rear legroom'],
        hybridOrElectric: 'None',
        type: 'SUV',
        size: 'compact',
      },
      {
        make: 'Ford',
        model: 'Edge',
        trims: ['SE', 'SEL', 'ST-Line', 'Titanium', 'ST'],
        averagePrice: 35000,
        pros: ['Sporty handling', 'Comfortable ride'],
        cons: ['Outdated interior', 'Limited third-row seating'],
        hybridOrElectric: 'None',
        type: 'SUV',
        size: 'mid-size',
      },
      {
        ...
        averagePrice: 45000,
        pros: ['Electric', 'Quick acceleration', 'Stylish design', 'Spacious interior'],
        cons: ['Charging infrastructure', 'Limited service centers', 'Expensive'],
        hybridOrElectric: 'Electric',
        type: 'SUV',
        size: 'compact',
      },
      {
        ...
        averagePrice: 90000,
        pros: ['Electric', 'Quick acceleration', 'Long range', 'Advanced technology'],
        cons: ['Charging infrastructure', 'Limited service centers', 'Expensive'],
        hybridOrElectric: 'Electric',
        type: 'Sedan',
        size: 'full-size',
      },
      {
        ...
        trims: ['Long Range', 'Plaid'],
        averagePrice: 100000,
        pros: ['Electric', 'Quick acceleration', 'Long range', 'Spacious interior', 'Advanced technology'],
        cons: ['Charging infrastructure', 'Limited service centers', 'Expensive'],
        hybridOrElectric: 'Electric',
         type: 'SUV',
        size: 'full-size',
      },
      {
        ...
        trims: ['SE', 'SEL', 'Limited', 'Calligraphy'],
        averagePrice: 30000,
        pros: ['Stylish design', 'Comfortable ride', 'Spacious interior'],
        cons: ['Mediocre fuel economy', 'Engine can be noisy'],
        hybridOrElectric: 'Hybrid Electric None',
         type: 'SUV',
        size: 'mid-size',
      },
      {
        make: 'Hyundai',
        model: 'Ioniq 5',
        trims: ['SE Standard Range', 'SE', 'SEL', 'Limited'],
        averagePrice: 42000,
        pros: ['Electric', 'Quick acceleration', 'Stylish design', 'Spacious interior'],
        cons: ['Charging infrastructure', 'Limited service centers', 'Expensive'],
        hybridOrElectric: 'Electric',
        ...
        averagePrice: 33000,
        pros: ['Stylish design', 'Spacious interior', 'Available hybrid and plug-in hybrid'],
        cons: ['Firm ride', 'Engine can be noisy'],
        hybridOrElectric: 'Hybrid Electric None',
        type: 'SUV',
        size: 'mid-size',
      },
      {
        ...
        make: 'Subaru',
        model: 'Crosstrek',
        trims: ['Base', 'Premium', 'Sport', 'Limited', 'Hybrid'],
        averagePrice: 24000,
        pros: ['Standard all-wheel drive', 'Good fuel economy', 'Spacious interior'],
        cons: ['Slow acceleration', 'Basic interior'],
        hybridOrElectric: 'Hybrid None',
        type: 'SUV',
        size: 'compact',
      },
      {
        make: 'Subaru',
        model: 'Ascent',
        trims: ['Base', 'Premium', 'Onyx Edition', 'Limited', 'Touring'],
        averagePrice: 35000,
        pros: ['Standard all-wheel drive', 'Spacious interior', 'Good safety ratings'],
        cons: ['Underpowered engine', 'Mediocre fuel economy'],
        hybridOrElectric: 'None',
        type: 'SUV',
        size: 'mid-size',
      },
      {
        make: 'Lexus',
        model: 'UX',
        trims: ['250h', '250h F Sport'],
        averagePrice: 35000,
        pros: ['Luxurious interior', 'Reliable', 'Good fuel economy', 'Available hybrid'],
        cons: ['Small cargo space', 'Uninspired handling'],
        hybridOrElectric: 'Hybrid',
        type: 'SUV',
        size: 'subcompact',
      },
      {
          ...
          trims: ['xDrive28i'],
          averagePrice: 38000,
          pros: ['Sporty handling', 'Luxurious interior', 'User-friendly tech'],
          cons: ['Expensive', 'Limited cargo space'],
          hybridOrElectric: 'None',
          type: 'SUV',
          size: 'subcompact',
      },
      {
        make: 'Mercedes-Benz',
        model: 'EQS',
        trims: ['450+', '580 4MATIC'],
        averagePrice: 105000,
        pros: ['Electric', 'Luxurious interior', 'Long range', 'Advanced technology'],
        cons: ['Expensive', 'Charging infrastructure', 'Limited service centers'],
        hybridOrElectric: 'Electric',
        type: 'Sedan',
        size: 'full-size',
      },
       {
          make: 'Audi',
          model: 'e-tron GT',
          trims: ['Premium Plus', 'Prestige', 'RS'],
          averagePrice: 103000,
          pros: ['Electric', 'Quick acceleration', 'Stylish design', 'Luxurious interior'],
          cons: ['Charging infrastructure', 'Limited service centers', 'Expensive'],
          hybridOrElectric: 'Electric',
          type: 'Sedan',
          size: 'compact',
      },
         {
          ...
          averagePrice: 75000,
          pros: ['Electric', 'Spacious interior', 'Comfortable ride', 'User-friendly tech'],
          cons: ['Charging infrastructure', 'Limited service centers', 'Expensive'],
          hybridOrElectric: 'Electric',
          type: 'SUV',
          size: 'mid-size',
          ...
          make: 'Land Rover',
          model: 'Defender',
          trims: ['90', '110', '130', 'S', 'SE', 'X-Dynamic SE', 'X', 'V8'],
          averagePrice: 60000,
          pros: ['Off-road capability', 'Stylish design', 'Spacious interior'],
          cons: ['Expensive', 'Poor fuel economy', 'Reliability concerns'],
          hybridOrElectric: 'Hybrid Electric None',
          type: 'SUV',
          size: 'mid-size',
      },
      {
        make: 'Porsche',
        model: 'Cayenne',
        trims: ['Base', 'E-Hybrid', 'S', 'GTS', 'Turbo', 'Turbo S E-Hybrid'],
        averagePrice: 75000,
        pros: ['Sporty handling', 'Powerful engine options', 'Luxurious interior'],
        cons: ['Expensive', 'Small cargo space', 'Options can add up quickly'],
        hybridOrElectric: 'Hybrid Electric None',
         type: 'SUV',
        size: 'mid-size',
      } ,
      {
        make: 'BMW',
        model: 'X7',
        trims: ['xDrive40i', 'M60i', 'Alpina XB7'],
        averagePrice: 78000,
        pros: ['Spacious interior', 'Luxurious interior', 'Comfortable ride'],
        cons: ['Expensive', 'Large size', 'Poor fuel economy'],
        hybridOrElectric: 'Hybrid Electric None',
        type: 'SUV',
        size: 'full-size',
      } ,
      {
          make: 'Mercedes-Benz',
          model: 'GLS',
          trims: ['450 4MATIC', '580 4MATIC', 'AMG GLS 63'],
          averagePrice: 80000,
          pros: ['Spacious interior', 'Luxurious interior', 'Comfortable ride'],
          cons: ['Expensive', 'Large size', 'Complex infotainment system'],
          hybridOrElectric: 'Hybrid Electric None',
          type: 'SUV',
          size: 'full-size',
      },
      {
        ...
        averagePrice: 55000,
        pros: ['Stylish design', 'Comfortable ride', 'Luxurious interior'],
        cons: ['Expensive', 'Limited cargo space', 'Infotainment system can be confusing'],
        hybridOrElectric: 'Hybrid Electric None',
        type: 'SUV',
        size: 'mid-size',
      } ,
      {
        make: 'Acura',
        model: 'Integra',
        trims: ['Base', 'A-Spec', 'A-Spec w/ Technology Package'],
        averagePrice: 32000,
        pros: ['Sporty handling', 'Stylish design', 'Fuel-efficient'],
        cons: ['Small back seat', 'Infotainment system can be confusing'],
        hybridOrElectric: 'None',
        type: 'Sedan',
        size: 'compact',
      }
